...
Section "Joget Workflow" SecJoget
  ...
  ${If} $INSTALL_TYPE == "${INSTALL_TYPE_UPGRADE}"
    ...
    RmDir /r "$INSTDIR\apache-tomcat-6.0.18\webapps\wflow-wfweb"
    RmDir /r "$INSTDIR\apache-tomcat-6.0.18\webapps\wflow-designerweb"
    CreateDirectory "$INSTDIR\apache-tomcat-6.0.18\webapps"
    File /oname=apache-tomcat-6.0.18\webapps\wflow-wfweb.war apache-tomcat-6.0.18\webapps\wflow-wfweb.war
    File /oname=apache-tomcat-6.0.18\webapps\wflow-designerweb.war apache-tomcat-6.0.18\webapps\wflow-designerweb.war
    CreateDirectory "$INSTDIR\data"
    File /oname=data\wflowdb-empty.sql data\wflowdb-empty.sql
    File /r wflow*.*
    File autoupdate.bat
    File build.xml
    File LICENSE.txt
...
Function CheckUpgrade
  ...
  ${If} ${FileExists} $INSTDIR\apache-tomcat-6.0.18\webapps\wflow-wfweb.war
...
Section "Uninstall"
  ...
  RmDir /r "$INSTDIR\apache-tomcat-6.0.18\webapps\wflow-wfweb"
  RmDir /r "$INSTDIR\apache-tomcat-6.0.18\webapps\wflow-designerweb"
  Delete "$INSTDIR\apache-tomcat-6.0.18\webapps\wflow-wfweb.war"
  Delete "$INSTDIR\apache-tomcat-6.0.18\webapps\wflow-designerweb.war"

  Delete "$INSTDIR\autoupdate.bat"
