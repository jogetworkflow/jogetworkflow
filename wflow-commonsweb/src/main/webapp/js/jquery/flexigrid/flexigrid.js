		...
		var g = {
			...
			addData: function (data) { //parse data
				...
				if (p.total==0)
                    ...
                    $('.gBlock').html('<div style="padding-top: 2em;text-align: center;font-size: 400%; color:silver"><b>' + p.nomsg + '</b></div>');
					return false;
					}
			...
			populate: function () { //get latest data
				...
				var param = [
					...
					,{ name : 'qtype', value : p.qtype}
                                ...
                                // CUSTOMIZED
				param = [
					 { name : 'start', value : (p.newp-1) * p.rp }
