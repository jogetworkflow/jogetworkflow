        ...
        function toggleCheckboxes(checkbox, divToUpdate){
            $.each($("." + divToUpdate + "-checkbox-list"), function(i, v){
                ...
                if($(checkbox).attr("checked")){
                    ...
                    $("#"+divToUpdate+"_selectedIds").html($("#"+divToUpdate+"_selectedIds").html()+","+$(tr).attr("id").substring(3));
                } else {
                    $(tr).removeClass("trSelected");
                    var removeString = $("#"+divToUpdate+"_selectedIds").html().replace(","+$(tr).attr("id").substring(3), "");
