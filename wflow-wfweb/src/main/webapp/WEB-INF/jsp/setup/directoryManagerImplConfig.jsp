...
<commons:popupHeader />
    ...
    <div id="main-body-header">
        <fmt:message key="wflowAdmin.directoryManagerImplConfig.view.label.title"/>
    </div>
    ...
    <div id="main-body-content" style="text-align: left">
        ...
        <form action="${pageContext.request.contextPath}/web/settings/setup/directoryManagerImpl/config/submit" class="form" method="POST">
            <fieldset>
                <legend><fmt:message key="general.plugin.configuration.label.pluginProperties"/></legend>
                <input type="hidden" name="directoryManagerImpl" value="${directoryManagerImpl}"/>
