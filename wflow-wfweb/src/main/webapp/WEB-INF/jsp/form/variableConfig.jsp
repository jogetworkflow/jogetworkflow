...
<commons:popupHeader />
    ...
    <div id="main-body-header">
        <fmt:message key="wflowAdmin.variable.config.label.title"/>
    </div>
    ...
    <div id="main-body-content" style="text-align: left">
        ...
        <form action="${pageContext.request.contextPath}/web/settings/form/variable/configure/submit" class="form" method="POST">
            <fieldset>
                <legend><fmt:message key="general.plugin.configuration.label.pluginProperties"/></legend>
                <input type="hidden" name="formVariableId" value="${formVariableId}"/>
