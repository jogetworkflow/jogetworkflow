...
<commons:popupHeader />
    ...
    <div id="main-body-header">
        <fmt:message key="usersAdmin.group.new.label.title"/>
    </div>

    <div id="main-body-content">    
        
        <c:url var="url" value="/web/directory/admin/group/save" />
        <form:form action="${url}" method="POST" commandName="group" cssClass="form">

            <form:errors path="*" cssClass="form-errors"/>

            <fieldset>
                <legend><fmt:message key="usersAdmin.group.new.label.details"/></legend>
                <div class="form-row">
                    <label for="id"><fmt:message key="usersAdmin.group.new.label.code"/></label>
                    <span class="form-input"><form:input path="id" cssErrorClass="form-input-error" /> * </span>
                </div>  
                <div class="form-row">
                    <label for="name"><fmt:message key="usersAdmin.group.new.label.name"/></label>
                    <span class="form-input"><form:input path="name" cssErrorClass="form-input-error" /> * </span>
                </div>       
                <div class="form-row">
                    <label for="description"><fmt:message key="usersAdmin.group.new.label.description"/></label>
