...
<commons:popupHeader />
    ...
    <div id="main-body-header">
        <fmt:message key="usersAdmin.grade.new.label.title"/>
    </div>

    <div id="main-body-content">

        <c:url var="url" value="/web/directory/admin/organization/grade/save" />
        <form:form action="${url}" method="POST" commandName="grade" cssClass="form">
            ...
            <fieldset>
                <legend><fmt:message key="usersAdmin.grade.new.label.details"/></legend><div class="form-row">
                <label for="id"><fmt:message key="usersAdmin.grade.new.label.code"/></label>
                    <span class="form-input"><form:input path="id" cssErrorClass="form-input-error" /> * </span>
                </div>  
                <div class="form-row">
                    <label for="name"><fmt:message key="usersAdmin.grade.new.label.name"/></label>
                    <span class="form-input"><form:input path="name" cssErrorClass="form-input-error" /> * </span>
                </div>       
                <div class="form-row">
                    <label for="description"><fmt:message key="usersAdmin.grade.new.label.description"/></label>
