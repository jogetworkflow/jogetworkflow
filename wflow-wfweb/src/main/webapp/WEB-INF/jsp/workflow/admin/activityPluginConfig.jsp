...
<commons:popupHeader />
    ...
    <div id="main-body-header">
        <fmt:message key="wflowAdmin.activityPluginConfig.view.label.title"/>
    </div>
    ...
    <div id="main-body-content" style="text-align: left">
        ...
        <form action="${pageContext.request.contextPath}/web/admin/process/activity/plugin/configure/submit" class="form" method="POST">
            <fieldset>
                <legend><fmt:message key="general.plugin.configuration.label.pluginProperties"/></legend>
                <input type="hidden" name="activityPluginId" value="${activityPluginId}"/>
