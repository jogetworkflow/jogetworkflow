...
<html>
    <body>
        <p>
        <img src="${pageContext.request.contextPath}/lib/img/loadingAnimation.gif" width="208" height="13" />
        </p>
        ...
        <c:set var="viewerUrl"><%= designerwebBaseUrl %>/wflow-designerweb/viewer/viewer.jsp?processId=${wfProcess.encodedId}</c:set>
