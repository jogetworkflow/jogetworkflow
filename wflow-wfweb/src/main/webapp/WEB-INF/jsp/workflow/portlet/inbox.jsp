...
<script>
            ...
            function inboxPopupDialog_${id}(activityId){
                var url = inboxUrlPath_${id}+"/web/client/assignment/view/"+activityId;
...
<div id="portlet_inbox_${id}">
    <div class="portlet_div_search">
        <div class="portlet_div_sorting">
            <span class="portlet_label"><fmt:message key="wflowClient.inbox.label.sorted.by"/></span>
            <span class="portlet_input">
                <select id="inboxFilterByDateCreated_${id}" name="dateCreated" onchange="inboxSortedByDateCreated_${id}()">
                    <option value="newest"><fmt:message key="wflowClient.inbox.label.newest"/></option>
                    <option value="oldest"><fmt:message key="wflowClient.inbox.label.oldest"/></option>
                </select>
            </span>
            <span>
        ...
        <div class="portlet_div_paging">
            <span class="portlet_label"><fmt:message key="wflowClient.inbox.label.page"/></span>
            <span class="portlet_input">
