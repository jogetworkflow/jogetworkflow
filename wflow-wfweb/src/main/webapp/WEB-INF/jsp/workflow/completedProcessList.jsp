...
<commons:header
    title="wflowAdmin.completed.process.list.label.title"
    helpTitle="wflowHelp.completed.process.list.title"
    help="wflowHelp.completed.process.list.content"
/>
    ...
    <div id="main-body-content">
        ...
        <ui:jsontable url="${pageContext.request.contextPath}/web/json/monitoring/completed/process/list?${pageContext.request.queryString}"
                       var="JsonDataTable"
                       ...
                       sort="createdTime"
                       desc="true"
                       href="${pageContext.request.contextPath}/web/monitoring/completed/process/view"
                       hrefParam="id"
                       hrefQuery="false"
                       hrefDialog="false"
...
<script>
    function removeProcessInstances(selectedList){
         if (confirm('<fmt:message key='wflowAdmin.running.process.view.label.removeProcess.confirm'/>')) {
                ...
                var request = ConnectionManager.post('${pageContext.request.contextPath}/web/monitoring/completed/process/removeMultiple', callback, 'wfProcessIds='+selectedList);
            }
    }
</script>